...
As a Senior Data Engineer you will lead development on new features and technical improvements for our products. You should be able to define technical design and implement work independently. You should have prior experience architecting systems.
...
- 3+ years of hands-on experience developing and applying data-driven solutions in e-commerce environment
- Professional experience with Big Data frameworks and visualization tools (Cassandra, Hadoop, Spark, ETL, AWS, Tableau)
- Fluency in a programming language (Python, Java, SQL, NoSQL)
...
- Familiarities with data lake and big data tools like apache spark is plus
