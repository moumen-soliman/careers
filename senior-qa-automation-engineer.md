<p align="center"><img src="https://i.ibb.co/ZzDxjFC/tl.png" alt="Tradeling" width="250"/></p>
...
As a Senior QA Automation Engineer you will lead development on new features and technical improvements for our products. You should be able to define technical design and implement work independently. You should have prior experience architecting systems.
...
- Minimum 3 years of experience of looking after multiple products 
- Designing, developing and maintaining test automation strategy, architecture and code, and leading other test automation engineers by example
- Professional experience with a automation testing frameworks like Appium, Selenium, Cypress, Jest etc
- Creating, reviewing and updating technical documentation for projects including: test strategies, test plans, and test cases
- Strong experience in developing automation frameworks from scratch built for UI and API testing and integration with CI pipeline
- Strong experience with creating and maintaining large scale test data frameworks to support test automation
- Strong knowledge of Devops & CI tools like Ansible, Kubernetes, Docker, Jenkins or equivalent
